...
public class AttributeValueNotStartsWithCheck extends Check {

	private String name;
	private List<String> values;
	
	public AttributeValueNotStartsWithCheck(String name, List<String> values) {
		this.name=name;
		this.values=values;
	}
	...
	public boolean execute(Element element, Document root) {
		...
		for(String value: values) {
			if(attrVal.startsWith(value.toLowerCase())) {
				return false;
			}
		}
		return true;
